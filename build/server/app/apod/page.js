...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3003)), "C:\\Users\\tijan\\Desktop\\git\\nasa-apis\\app\\apod\\loading.tsx"],
    ...
    const originalPathname = "/apod/page"
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ apodLayout),
...
const ApodData = async ()=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "max-w-3xl mx-auto rounded-lg shadow-md p-6 mt-20",
        children: [
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ApodData);
